...
fn usage() -> String {
    [
        ...
        "  magpie accounts add claude       sign in to another Claude account",
        "  magpie accounts add codex        sign in to another ChatGPT account",
        "  magpie accounts add copilot      sign in to another GitHub Copilot account",
        "  magpie accounts add grok         sign in to a Grok CLI account",
        "  magpie accounts switch claude <user> switch a remembered Claude account",
        "  magpie accounts forget claude <user> forget a saved Claude account",
        ...
        "  magpie accounts switch copilot <user> switch a remembered Copilot account",
        "  magpie accounts forget copilot <user> forget a saved Copilot account",
        "  magpie accounts switch grok <user> switch a remembered Grok account",
        "  magpie accounts forget grok <user> forget a saved Grok account",
        "",
